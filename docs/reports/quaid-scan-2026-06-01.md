# quaid-scanner Report: /Users/karstenwade/Projects/AINative-Studio/src/travelpal

**Score:** 🔴 2.2/10 — CRITICAL risk
**Maturity:** sandbox | **Depth:** standard | **Duration:** 0.2s
**Scanned:** 2026-06-01T21:47:31.383Z
...
| Inclusive Language | 2.5 | 15% | 0C 4W 3I |
...
- **[vendor-neutrality-high-concentration]** High vendor concentration: gmail.com (88% of commits) *(Encourage contributions from additional organizations to improve vendor diversity)*
...
- **[bus-factor-1]** Bus factor: 1, Elephant factor: 88% (2 contributors, 8 commits in last 12 months)
...
- **[vendor-neutrality-domain-count]** Found 2 unique email domain(s) across 8 commits
...
- **[contributor-data-1]** 2 unique contributors with 8 commits in the last 12 months
...
- **[AK-GIT-CLONE-README.md:27]** Assumed knowledge: "clone" operation used without explanation
- **[AK-GIT-CLONE-README.md:29]** Assumed knowledge: "clone" operation used without explanation
- **[AK-GIT-BRANCH-README.md:62]** Assumed knowledge: "branch" operation used without explanation
...
| Inclusive Language | 15% | 2.5 | 0.38 |
| Technical Rigor | 10% | 3.0 | 0.30 |
| **Overall** | **100%** | | **2.20** |

---
*quaid-scanner v0.1.2 | 2026-06-01T21:47:31.383Z*
*Commit: 1684084799440452b09e93de01aef7d3b2611ba5*